app.component("product-display", {
    ...
    template:
        ...
        <button class="button" :class="{disabledButton: !inStock}" :disabled="!inStock" v-on:click="addToCart"> Добавить в корзину</button>
        <button class="button" v-on:click="removeFromCart">Очистить корзину</button>
        </div>
        </div>
